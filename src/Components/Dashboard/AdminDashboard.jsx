...
const AdminDashboard = () => {
    ...
    <div className='h-screen w-full p-10'>
      ...
      <div className="p-5 bg-[#1c1c1c] mt-7 rounded">
        <form  className="flex flex-wrap w-full items-start justify-between">
            ...
            <input className='text-sm py-1 px-2 w-4/5 rounded outline-none bg-transparent border-[1px] border-grey-400 mb-4' type="text" placeholder='Make a Ui Design' />
            </div>
                   <div>
            ...
            <h3 className='text-sm text-grey-300 mb-0.5'>Assign to</h3>
                <input className='text-sm py-1 px-2 w-4/5 rounded outline-none bg-transparent border-[1px] border-grey-400 mb-4' type="text" placeholder='Employee Name' />
            </div>
            <div>
  ...
  <textarea className='w-full h-44 text-sm py-1 px-2 rounded outline-none bg-transparent border border-gray-400' name="" id=""></textarea>
